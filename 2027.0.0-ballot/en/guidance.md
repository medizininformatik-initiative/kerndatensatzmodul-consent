# Guidance - MII Implementation Guide Consent v2027.0.0-ballot
...
* **[Data Sets and Descriptions](logical-models.md)** — the module's data elements, described as logical models.
...
> The representation of the consent questionnaires (Questionnaire-based content) is described on the subpage [Questionnaires](frageboegen.md).
