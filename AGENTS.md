...
- **German is the IG's default language, English the translation**
  (`i18n-default-lang: de`, translations under `input/translations/en/` —
  DE-first per the MII meta wiki Release-2027 decision; migration decision D-3).
  This deliberately inverts the same
