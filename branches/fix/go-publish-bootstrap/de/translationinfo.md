# Hinweise zur Übersetzung - MII Implementation Guide Consent v2027.0.0-ballot
...
Alle Leitfaden-Seiten dieses Moduls liegen als **maschinelle englische Übersetzungen** der deutschen Quellseiten vor (Migrationsstand 2026-08-31; die fachliche Durchsicht der Übersetzungen erfolgt fortlaufend). Die Ressourcen-Titel übersetzt der IG-Level-Katalog `input/translations/en/ImplementationGuide-mii-ig-consent.po`.
