# Logische Modelle - MII Implementation Guide Consent v2027.0.0-ballot
...
Das Modul **Consent** definiert keine eigenen FHIR Logical Models; die fachliche Datensatzbeschreibung ist vollständig in ART-DECOR hinterlegt (siehe unten).

### Datensätze inkl. Beschreibungen

Die Datensatzbeschreibung des KDS Modul Consent ist vollumfänglich im ART-DECOR hinterlegt:
