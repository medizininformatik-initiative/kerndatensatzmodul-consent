# CodeSystems - MII Implementation Guide Consent v2027.0.0-ballot.rc1
...
Diese Seite beschreibt die CodeSystems des Moduls **Consent**. Die darauf aufbauenden ValueSets beschreibt die Seite [ValueSets](value-sets.md).
...
Codes für die Broad-Consent-Versionen und Zusatzmodule (`urn:oid:2.16.840.1.113883.3.1937.777.24.5.27`): siehe die Artefaktseite [mii-cs-consent-version-modules](CodeSystem-mii-cs-consent-version-modules.md).

### MII_CS_Consent_Answer

Antwort-Codes (`urn:oid:2.16.840.1.113883.3.1937.777.24.5.2`): siehe die Artefaktseite [MII_CS_Consent_Answer](CodeSystem-2.16.840.1.113883.3.1937.777.24.5.2--20210423105554.md).
