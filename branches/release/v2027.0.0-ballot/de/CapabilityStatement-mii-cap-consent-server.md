# MII KDS Modul Consent — CapabilityStatement (Migrationsvorschlag) - MII Implementation Guide Consent v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII KDS Modul Consent — CapabilityStatement (Migrationsvorschlag)**

## CapabilityStatement: MII KDS Modul Consent — CapabilityStatement (Migrationsvorschlag) (Experimentell) 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-consent/CapabilityStatement/mii-cap-consent-server | *Version*:2027.0.0-ballot |
...
MIGRATION-GENERATED PROPOSAL (not part of the published 2026.0.0 release): server capabilities derived from the module's profiles and search parameters during the migration onto the MII KDS module template. The module team confirms, amends or deletes this artefact at Gate A. 
 ...
 [Rohdatei der OpenAPI-/Swagger-Definition](../mii-cap-consent-server.openapi.json) | [Download](../mii-cap-consent-server.openapi.json) 
