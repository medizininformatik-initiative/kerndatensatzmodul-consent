# Beispiel Patient (pseudonym, synthetisch) - MII Implementation Guide Consent v2027.0.0-ballot
...
Profile: [Consent Management: Patient](https://simplifier.net/resolve?scope=de.einwilligungsmanagement@2.0.4-snapshots&canonical=http://fhir.de/ConsentManagement/StructureDefinition/Patient)
