# Profile - MI-I - Consent - Einwilligung - MII Implementation Guide Consent v2027.0.0-ballot
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-consent/StructureDefinition/mii-pr-consent-einwilligung | *Version*:2027.0.0-ballot |
...
> Die Datenschutz-Aspekte dieses Profils beschreibt die Seite [Sicherheit und Datenschutz](security-and-privacy.md); die Suchparameter beschreibt die Seite [Suchparameter](search-parameters.md).
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-consent-einwilligung.csv), [Excel](../StructureDefinition-mii-pr-consent-einwilligung.xlsx), [Schematron](../StructureDefinition-mii-pr-consent-einwilligung.sch) 
