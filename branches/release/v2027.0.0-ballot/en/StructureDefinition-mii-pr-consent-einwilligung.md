...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-consent/StructureDefinition/mii-pr-consent-einwilligung | *Version*:2027.0.0-ballot |
...
> The security and privacy aspects of this profile are described on the page [Security and Privacy](security-and-privacy.md); the search parameters are described on the page [Search Parameters](search-parameters.md).
