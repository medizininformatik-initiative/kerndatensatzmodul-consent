...
| Placeholder | Where |
|---|---|
| `2027.0.0-ballot` | `version.fsh`, `meta-profile.fsh`, `cps-rules.fsh` |
| `consent` | `version.fsh` (package id + canonical of the package source) |
| `2026` | `version.fsh` (`resource-effectivePeriod.start`) |
| `2019` | `crmi.fsh` (`artifact-copyrightLabel`) |
| `info@medizininformatik-initiative.de` | `crmi.fsh` (`artifact-author`) |
| `2025-12-18` | passed in at the call site: `insert CRMIApprovalDate(2025-12-18)` |
| `C16735` | passed in at the call site: `insert CRMIArtifactTopic(…, C16735)` |
