...
//   the basis artifact-author contact email      → info@medizininformatik-initiative.de
// The approval date and the artifact topic stay RuleSet PARAMETERS (as in
// basis); pass 2025-12-18 / C16735 at the call site.
// ─────────────────────────────────────────────────────────────────────────────
...
// Call with the module's approval date, e.g. `insert CRMIApprovalDate(2025-12-18)`.
...
//   insert CRMIArtifactTopic(http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl, C16735)
...
// Author = the module author (info@medizininformatik-initiative.de). Editor / reviewer /
...
* ^extension[=].valueContactDetail.telecom[=].value = "info@medizininformatik-initiative.de"
