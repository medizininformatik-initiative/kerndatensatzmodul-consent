...
Diese Seite beschreibt die CodeSystems des Moduls **Consent**. Die darauf
aufbauenden ValueSets beschreibt die Seite [ValueSets](value-sets.html).
...
Codes für die Broad-Consent-Versionen und Zusatzmodule
(`urn:oid:2.16.840.1.113883.3.1937.777.24.5.27`): siehe die Artefaktseite
[mii-cs-consent-version-modules](CodeSystem-mii-cs-consent-version-modules.html).

### MII_CS_Consent_Answer

Antwort-Codes (`urn:oid:2.16.840.1.113883.3.1937.777.24.5.2`): siehe die
Artefaktseite
[MII_CS_Consent_Answer](CodeSystem-2.16.840.1.113883.3.1937.777.24.5.2--20210423105554.html).

<!-- Policy-Tabelle aktualisiert aus terminologie/codesystems/CodeSystem-MiiConsentPolicy.md @ develop 744f7ba (develop-Inkorporation 2026-09-01; durchgestrichen = deprecated). -->
