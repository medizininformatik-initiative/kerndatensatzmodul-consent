...
<!--
  HOME PAGE — GERMAN, the SOURCE page of this DE-first module
  (i18n-default-lang: de, migration decision D-3). The structure follows the
  standard MII module IG page set (MII IG template and kerndatensatz-basis).
  The English translation lives at input/translations/en/pagecontent/index.md —
  keep both in step.
-->
...
- **[Abhängigkeiten](ImplementationGuide-mii-ig-consent.html)** — die
