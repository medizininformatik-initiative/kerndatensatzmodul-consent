...
This module produces a bilingual IG with **German as the default language and
English as the translation** (DE-first per the MII meta wiki Release-2027
decision; migration decision D-3). This deliberately INVERTS the template's
stock model (English-default, as in
...
5. **Page titles, breadcrumbs and the table of contents:** these come from the
   ...
   `ImplementationGuide-mii-ig-consent.po` — **rename it** to match your
