...
<!-- ENGLISH TRANSLATION of the source page
     input/pagecontent/translationinfo.md (German is the default language of
     this DE-first module, migration decision D-3). -->


This guide is written in **German** (the default language); **English** is the
translation. German is therefore both the base rendering of the guide and the
`/de/` rendering; use the language switcher at the top right to move between
`/de/` and `/en/`.
