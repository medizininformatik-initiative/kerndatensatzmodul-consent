...
| `language-model-check.sh` | Fails the build when prose contradicts the German-default / English-translation language model (DE-first, decision D-3) | `convention-check.yml` |
